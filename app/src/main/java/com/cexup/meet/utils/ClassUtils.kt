...
//import io.agora.agorauikit_android.BuildConfig
import java.io.File
...
//        }
    ...
    }// let isMultidexCapable be false// Native Android system// YunOS need special judgment
    ...
    private val isYunOS: Boolean
        private get() = try {
            ...
            (vmName != null && vmName.lowercase(Locale.getDefault())
                .contains("lemur") || version != null && version.trim { it <= ' ' }.length > 0)
        } catch (ignore: Exception) {
            false
        }
}
